...
class ExperimentTracker:
    ...
    def __init__(self, member_name: str, output_file: str = None):
        self.member_name = member_name
        # Save experiments per member
        if output_file is None:
            os.makedirs("experiments", exist_ok=True)
            output_file = f"experiments/{self.member_name.replace(' ','_')}_experiments.json"
    ...
    def get_summary(self) -> str:
        """Return a text summary of experiments"""
        summary = f"\n{'='*60}\n"
    ...
    def export_to_markdown(self) -> str:
        """Export experiments as a markdown table for README"""
...
# Example usage for Deolinda
if __name__ == "__main__":
    tracker = ExperimentTracker("Deolinda Bio Bogore")
    print("Tracker initialized for Deolinda.")